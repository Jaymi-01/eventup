...
const Setup = () => {
  ...
  <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 md:pt-0">
    <button className="bg-accent-darkest hover:bg-accent-darker text-white font-medium px-8 py-3 rounded-md transition w-full md:w-auto">
      Create Conference
    </button>
    <button className="border border-white text-white px-8 py-3 rounded-md hover:bg-white hover:text-bg-darkest transition w-full md:w-auto">
      Watch story
    </button>
  </div>
</div>
